...
for f in file_list:
    ...
    bpy.ops.export_scene.obj(filepath=str(output_obj_filename), use_mesh_modifiers=True, group_by_material=True, use_triangles=True, use_blen_objects=True, use_normals=True, axis_forward='X', axis_up='-Z')
